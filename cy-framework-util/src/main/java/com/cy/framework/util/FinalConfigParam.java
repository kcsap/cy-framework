...
public class FinalConfigParam {
    ...
    // "localhost"
    public static final String SERVER_PORT = "serverport";// 服务器端口
    public static final String SERVER_TYPE = "servertype";// 服务的请求类型 "http"
    public static final String SERVER_PROJECT = "serverproj";// 项目工程名
    public static final String SERVER_URL = "serverurl";// 服务器的证实路径
