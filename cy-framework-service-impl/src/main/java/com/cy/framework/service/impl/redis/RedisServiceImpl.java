...
public class RedisServiceImpl implements RedisService {
     ...
     */
    @Override
    public void cachePut(RedisCacheParam cacheParam) {
        final byte[] rawKey = redisTemplate.getKeySerializer().serialize(cacheParam.getKey());
        final byte[] rawValue = redisTemplate.getValueSerializer().serialize(cacheParam.getValue());
        redisTemplate.execute(new RedisCallback<Object>() {
            ...
            public void potentiallyUsePsetEx(RedisConnection connection) {
                if (!TimeUnit.MILLISECONDS.equals(TimeUnit.SECONDS) || !this.failsafeInvokePsetEx(connection)) {
                    connection.setEx(rawKey, TimeoutUtils.toSeconds(cacheParam.getMinutes(), TimeUnit.SECONDS), rawValue);
                }
            ...
            private boolean failsafeInvokePsetEx(RedisConnection connection) {
                ...
                try {
                    connection.pSetEx(rawKey, cacheParam.getMinutes(), rawValue);
